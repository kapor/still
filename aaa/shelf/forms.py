...
class ShelfEntryForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['price'].widget.attrs.update({'class': 'field_decimal', 'placeholder': '', 'id': 'id_price'})
        ...
        self.fields['tags'].widget.attrs.update({'class': 'field_char', 'placeholder': 'Comma-separated', 'id': 'id_tags'})
